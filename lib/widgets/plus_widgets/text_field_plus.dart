...
import 'plus_utils/text_decoration_plus.dart';
import 'plus_utils/text_field_mask_plus.dart';
...
class TextFieldPlus extends StatelessWidget {
  ...
  TextFieldPlus(
      ...
      this.fontFamilyStyle = GoogleFonts.poppins});

  static late ContainerPlus _containerPlus;
